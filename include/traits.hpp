...
template <typename X, typename Y> constexpr bool Same() {
...
template <typename X, typename Y> constexpr bool Convertible() {
...
template <typename M> constexpr bool Has_matrix_type() {
